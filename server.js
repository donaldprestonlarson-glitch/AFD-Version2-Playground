...
function safeUser(u){ 
  ...
  return { id: u.id, name: u.name, age: u.age, city: u.city, gender: u.gender||'Man', bio: u.bio, photo_url: (photos?.[0]||null), photos: photos||[], created: u.created, height: u.height||'', body_type: u.body_type||'', height_inches: u.height_inches||0, pinned: !!(u.pinned && u.pinned!=0) || (u.name||'').toLowerCase().includes('dee'), pinned: !!u.pinned }; 
}
